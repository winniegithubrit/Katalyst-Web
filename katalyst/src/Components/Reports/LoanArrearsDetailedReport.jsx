...
const LoanArrearsDetailedReport = ({ data, companyInfo, selectedBranch, submittedFilters, onProcessedDataChange }) => {
                        ...
                        {officer.records.map((row, rowIndex) => {
                          return (
                            ...
                            >
                              ...
                              <td className="border border-gray-300 px-2 py-2 text-xs text-gray-900 text-right">
                                {formatCurrency(row.PenaltyAmount|| 0)}
                              </td>
                              <td className="border border-gray-300 px-2 py-2 text-xs text-gray-900 text-right">
...
export default LoanArrearsDetailedReport;
